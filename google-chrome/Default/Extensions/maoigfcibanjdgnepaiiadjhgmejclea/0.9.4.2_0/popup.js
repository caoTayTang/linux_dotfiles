...
(function (UrlEditor) {
    function initialize(storage) {
        ...
        var settings = new UrlEditor.Settings(storage);
        ...
        UrlEditor.Tracking.init(settings.trackingEnabled, "/popup.html", true, version);
        new UrlEditor.RichTextboxViewModel(document);
        var versionElem = UrlEditor.Helpers.ge("version");
        ...
        UrlEditor.Helpers.getActiveTab(tab => {
            ...
            UrlEditor.Plugins.ViewModel.forEach(plugin => new plugin(settings, this));
        });
    }
    ;
